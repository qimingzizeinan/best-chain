...
import { errorStep, emptyDirSync, isExistsSync, mkdirSync, isEmptyDir, copy } from '@best-chain/utils';
...
function getTemplates() {
    return FRAMEWORKS.map(function (item) { return item.name; });
}
...
var isNotJoinTargetDir = (function () {
...
function getFrameworkByName(name) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, FRAMEWORKS.find(function (item) {
                    return item.name === name;
                })];
        });
    });
}
function selectTemplate(targetDir, argTemplate) {
    return __awaiter(this, void 0, void 0, function () {
        var result, r, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    result = {
                ...
                case 1:
                    _a.trys.push([1, 6, , 7]);
                    if (!!isNotJoinTargetDir) return [3 /*break*/, 3];
                    return [4 /*yield*/, prompts([
                            {
                                type: function () { return (!isExistsSync(targetDir) || isEmptyDir(targetDir) ? null : 'confirm'); },
                                name: 'overwrite',
                                message: function () {
                                    return (targetDir === '.' ? 'Current directory' : "Target directory \"".concat(targetDir, "\"")) +
                                        ' is not empty. Remove existing files and continue?';
                                }
                            },
                            {
                                type: function () { return (isValidPackageName(getProjectName(targetDir)) ? null : 'text'); },
                                name: 'packageName',
                                message: reset('Package name:'),
                                initial: function () { return toValidPackageName(getProjectName(targetDir)); },
                                validate: function (dir) { return isValidPackageName(dir) || 'Invalid package.json name'; }
                            },
                            {
                                ...
                                message: typeof argTemplate === 'string' &&
                                    ...
                                    ? reset("\"".concat(argTemplate, "\" isn't a valid template. Please choose from below: "))
                ...
                case 2:
                    ...
                    _a.label = 3;
                case 3:
                    if (!(!result.framework && argTemplate)) return [3 /*break*/, 5];
                    return [4 /*yield*/, getFrameworkByName(argTemplate)];
                case 4:
                    r = _a.sent();
...
function init() {
    return __awaiter(this, void 0, void 0, function () {
        var targetDir, argTemplate, result, framework, overwrite, packageName, root, template, pkgManager, templateDir, write, files, _i, _a, file, packagePath, pkg, cdProjectName;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, selectTemplate(targetDir, argTemplate)];
                case 1:
                    result = _b.sent();
                    framework = result.framework, overwrite = result.overwrite, packageName = result.packageName;
                    if (!framework)
                        return [2 /*return*/];
                    if (!framework.ready) {
                    ...
                    root = isNotJoinTargetDir ? cwd : path.join(cwd, targetDir);
                    if (overwrite) {
                        emptyDirSync(root);
                    }
                    ...
                    template = framework.name || argTemplate;
                    pkgManager = 'pnpm';
                    templateDir = path.resolve(fileURLToPath(import.meta.url), '../../templates', "template-".concat(template === null || template === void 0 ? void 0 : template.toLocaleLowerCase()));
                    write = function (file, content) {
                        var targetPath = path.join(root, file);
                        if (content) {
                    ...
                    console.log('\nDone. Now run:\n');
                    if (root !== cwd) {
                        console.log(blue("  cd ".concat(cdProjectName.includes(' ') ? "\"".concat(cdProjectName, "\"") : cdProjectName)));
                    }
                    console.log(blue("  ".concat(pkgManager, " install")));
                    console.log(blue("  ".concat(pkgManager, " run dev")));
                    return [2 /*return*/];
            }
        });
    });
...
export { formatTargetDir, getProjectName, init };
